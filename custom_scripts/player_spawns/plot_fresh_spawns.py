#!/usr/bin/env python3
"""
Plot fresh player spawn bubbles from cfgplayerspawnpoints.xml on the Hashima map.
"""
...
PREFERRED_MISSION_DIR = MPMISSIONS_DIR / "main.hashima"

DEFAULT_MAP_SIZE = 5200.0
DEFAULT_EXTENT = (0.0, DEFAULT_MAP_SIZE, 0.0, DEFAULT_MAP_SIZE)
DEFAULT_BACKGROUND_IMAGE = CUSTOM_SCRIPTS_DIR / "assets" / "hashima-map-background.png"
