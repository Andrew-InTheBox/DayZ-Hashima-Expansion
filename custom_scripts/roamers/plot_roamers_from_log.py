...
def plot_ai_patrol_coords(log_file_path, map_image_path, output_dir, dot_color='yellow', scale=5200):
...
def main():
    ...
    map_image_path = os.path.join(base_path, 'custom_scripts', 'assets', 'hashima-map-background.png')
