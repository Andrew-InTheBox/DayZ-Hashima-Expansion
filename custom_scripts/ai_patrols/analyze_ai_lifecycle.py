...
DEFAULT_PATROL_SETTINGS = (
    REPO_ROOT / "mpmissions" / "main.hashima" / "expansion" / "settings" / "AIPatrolSettings.json"
)
DEFAULT_MAP_IMAGE = CUSTOM_SCRIPTS_DIR / "assets" / "hashima-map-background.png"
...
def plot_map(path: Path, lifecycles: list[Lifecycle], map_image_path: Path) -> None:
    ...
    if map_image_path.exists():
        ...
        ax.imshow(image, extent=(0, 5200, 0, 5200), origin="upper")
