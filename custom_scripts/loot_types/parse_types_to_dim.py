...
if __name__ == "__main__":
    ...
    input_files = {
        'types': os.path.join(base_path, 'mpmissions', 'main.hashima', 'db', 'types.xml'),
        'mmg': os.path.join(base_path, 'mpmissions', 'main.hashima', 'db', 'mmg', 'mmg_bare_types.xml'),
        'expansion': os.path.join(base_path, 'mpmissions', 'main.hashima', 'db', 'expansion_ce', 'expansion_types.xml'),
        'snafu': os.path.join(base_path, 'mpmissions', 'main.hashima', 'db', 'snafu', 'SNAFU_bare_types.xml')
    }
